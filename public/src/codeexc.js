...
$(document).ready(function() {
  getLqxInfo("LQX_CBRL", "sell", 20);
  getLqxInfo("LQX_CBRL", "buy", 50);
});
...
function getLqxInfo(coinPair, operation, quantity) {
  var url = `https://trade.exccripto.com/api/v3/public/getorderbook?market=${coinPair}&type=${operation}&depth=${quantity}`;
  var type = operation;
  var priceFound;
